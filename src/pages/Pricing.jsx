  ...
  const plansData = useMemo(() => {
    ...
    if (launchOfferActive) {
      ...
      const regularPlans = [
        ...
        { id: 'fullService', category: 'Full Service', name: 'Full Service', format: 'Print + Ebook', books: '1 book', price: '$499', perBook: '$499', features: ['1 book project', 'Full book export', 'AI-assisted formatting', 'Watermark-free output', 'Word document splitting by H1 sections', '11 images included', '3 custom cover designs'], details: 'Complete publishing package with custom cover designs (Final PDF and eBook delivery within 72 hours of cover approval)', planId: 'fullService' },
        { id: 'fullServicePlus', category: 'Full Service', name: 'Full Service Plus', format: 'Print + Ebook', books: '1 book', price: '$599', perBook: '$599', features: ['1 book project', 'Full book export', 'AI-assisted formatting', 'Watermark-free output', 'Word document splitting by H1 sections', '11 images included', '3 custom cover designs', '30-minute guided KDP Amazon setup session'], details: 'Complete package with custom covers and KDP setup guidance (Final PDF and eBook delivery within 72 hours of cover approval)', planId: 'fullServicePlus' }
      ];
