        ...
        <Container maxWidth="lg">
          <Grid container spacing={2} justifyContent="space-between">
            <Grid item xs={12} md={4}>
              <Box 
                component="img"
                src={require('./assets/publishjockey_logo_white.png')} 
                alt="PublishJockey Logo White"
                sx={{ 
                  height: '50px',
                  mb: 2
                }}
            ...
            <Grid item xs={12} md={8}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={6} sm={3}>
                  ...
                  <Box component="nav">
                    <Typography component="a" href="/about" sx={{ display: 'block', color: 'rgba(255,255,255,0.7)', mb: 1, textDecoration: 'none', '&:hover': { color: 'white' } }}>
                      About
                    </Typography>
                    <Typography component="a" href="/" sx={{ display: 'block', color: 'rgba(255,255,255,0.7)', mb: 1, textDecoration: 'none', '&:hover': { color: 'white' } }}>
                      Blog
          ...
          <Typography variant="body2" sx={{ opacity: 0.7, textAlign: 'center' }}>
            © {new Date().getFullYear()} <Box component="img" src={require('./assets/publishjockey_logo_white.png')} alt="PublishJockey Logo White" sx={{ height: 20, display: 'inline', verticalAlign: 'middle', mx: 1 }} />. All rights reserved.
          </Typography>
        </Container>
      </Box>
    </Box>
